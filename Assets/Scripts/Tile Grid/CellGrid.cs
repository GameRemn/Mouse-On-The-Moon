...
public class CellGrid : MonoBehaviour
{
    ...
    public Vector3Int numberOfColumnsRowsLayers;
    ...
    public List<Cell> NeighbordCells(Cell cell, List<Vector3Int> neighbordCellsIndexesOffset) //Определение соседних ячеек
    {
    ...
    public List<Cell> NeighbordCells(Tile tile, List<Vector3Int> neighbordCellsIndexesOffset)
    {
